...
export default function Hero() {
  return (
    <header className="bg-white pl-14 p-10" id="home">
      <div className="container mx-auto grid h-full gap-10 min-h-[60vh] w-full grid-cols-1 items-center lg:grid-cols-2">
        {/* Left Side */}
        <div className="row-start-2 lg:row-auto">
          <h1 className="block antialiased tracking-normal font-sans font-bold text-blue-gray-900 mb-4 lg:text-5xl text-3xl leading-tight">
            Hi, I’m Karthik Kasarla
          </h1>

          <p className="block antialiased font-sans text-lg font-normal leading-relaxed text-gray-600 mb-4 md:pr-16 xl:pr-28">
            MS in Information Systems | Software Developer | Ex-Accenture
          </p>

          <p className="block antialiased font-sans text-base text-gray-700 mb-6 max-w-xl">
            I build efficient software solutions, explore tech on GitHub &
            LeetCode, and love turning ideas into impactful applications.
          </p>
